 ...
 */
		 ...
		 $.ajax({
		 	...
		 	success: function(msg){
		 		...
		 		car2.loadingPageHide();
		 		 ...
		 		 if(msg.code==200){
		 		car2.showCheckMessage('123',true)
		 		setTimeout(function(){
	...
	*/},
	...
	refresh	: function(){
    car2_windowHeight = $(window).height();
		car2._windowWidth = $(window).width();
	},
 	plugin : function(){
		car2.mapCreate();
		$('#coffee_flow').coffee({
			steams				: ["<img src='img/audio_widget_012x.png' />","<img src='img/audio_widget_012x.png' />"], 
			steamHeight			: 100,
			steamWidth			: 44 
		});
...
//		car2.cover_draw(node,url,canvas_url,type,w,h,callback);
		...
		if($('#r-cover').val()!='') option_wx.con = $('#r-wx-con').val();
